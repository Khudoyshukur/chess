...
Java_uz_safix_engine_1lc0_Lc0JniImpl_main(JNIEnv *env, jobject thiz, jstring weightsPath) {
...
Java_uz_safix_engine_1lc0_Lc0JniImpl_readLine(JNIEnv *env, jobject thiz) {
    return readFd(env, PARENT_READ_FD);
}

extern "C"
JNIEXPORT jstring JNICALL
Java_uz_safix_engine_1lc0_Lc0JniImpl_readError(JNIEnv *env, jobject thiz) {
    return readFd(env, PARENT_ERROR_FD);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_uz_safix_engine_1lc0_Lc0JniImpl_write(JNIEnv *env, jobject thiz, jstring command) {
